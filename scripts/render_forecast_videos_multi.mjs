 ...
 *
 * Generates exactly six videos per run:
 *   - NOAA East Asia: L1 + GPS VDOP×L1
 *   - ISEE Japan Close: L1 + GPS VDOP×L1
 *   - NOAA Philippines: L1 + GPS VDOP×L1
 */
...
const VIDEO_ROOT = path.join(DOCS, "data", "videos_multi");
...
const VIDEO_VIEWS = [
  ...
  // NOAA Philippines / South China Sea
  {
    key: "philippines",
    sources: ["noaa"],
